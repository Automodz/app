 ...
 * the same way a photograph is not "decorative colour" either.
 *
 * Sized in `em` so it tracks whatever type the control is set in.
 */
export function GoogleMark({ size = '1.15em' }: { size?: string | number }) {
  return (
    <svg
      width={size}
      height={size}
